		...
		<div class="row">
			...
			<c:forEach items="${page.content}" var="model">
				<div class="row">
					...
					<div class="col-md-4 col-xs-4"><a class="btn btn-warning" href="/admin/model/update/${model.id}<custom:allParams/>">update</a></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/model/delete/${model.id}<custom:allParams/>">delete</a></div>
				</div>
			</c:forEach>
	</div>
